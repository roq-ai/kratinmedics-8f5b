...
import { deleteSeniorUserById } from 'apiSdk/senior-users';
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Box>
              ...
              {hasAccess('senior_user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    <Text fontSize="lg" fontWeight="bold">
                      Senior Users
                    </Text>
                    <NextLink passHref href={`/senior-users/create?health_plan_id=${data?.id}`}>
                    ...
                    <Table variant="simple">
                      ...
                      <Tbody>
                        {data?.senior_user?.map((record) => (
                          <Tr
                            cursor="pointer"
                            onClick={() => router.push(`/senior-users/view/${record.id}`)}
                            key={record.id}
                          >
                            ...
                            <Td>
                              {hasAccess('senior_user', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                                <NextLink
                                  onClick={(e) => e.stopPropagation()}
                                  passHref
                                  href={`/senior-users/edit/${record.id}`}
                                >
